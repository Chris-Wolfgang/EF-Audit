...
/// across Insert, Lifecycle, and MixedStates workloads. SQLite is used for a
/// consistent, dependency-free baseline; the relative delta between the two
...
public class SaveChangesBenchmarks
{
    ...
    /// variant's audit tables would grow across iterations and skew the delta over
    /// time.
    /// </summary>
