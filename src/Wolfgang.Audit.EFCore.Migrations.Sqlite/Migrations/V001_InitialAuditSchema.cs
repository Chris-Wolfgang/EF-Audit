...
namespace Wolfgang.Audit.Migrations.Sqlite.Migrations;



/// <summary>
/// Initial audit schema migration for SQLite. Reads <see cref="AuditOptions"/>
/// at apply time (Approach B). SQLite has no schemas; <see cref="AuditOptions.Schema"/>
/// is ignored. DateTimes are stored as ISO-8601 TEXT (EF Core's default for SQLite).
/// </summary>
    ...
    private void CreateHeaderTable(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                AuditedAtUtc      = table.Column<DateTime>(nullable: false),
